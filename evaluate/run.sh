...
declare -a patterns=("equality" "range" "membership" "cp_equality" "cp_range" "cp_membership")
...
do
  ...
  do
    ...
    # Witness
    zokrates compile -i "$INDIR/$ZOKFILE" -o "$OUTDIR/$OUTFILE" -r "$OUTDIR/$OUTFILE.r1cs" --debug
